  ...
  return (
    <SectionWrapper id="contact" title="Contact" subtitle="Discutons de votre prochain projet.">
      <div ref={inner} className="max-w-xl mx-auto">
        <div data-gsap className="contact-box rounded-xl p-10 md:p-12 text-center bg-white/[0.02] border border-white/[0.05]">
          <div className="w-14 h-14 rounded-xl bg-primary/[0.08] flex-center mx-auto mb-6">
          ...
          <p className="text-text-secondary text-base mb-4 leading-relaxed max-w-md mx-auto">
          ...
          <p className="text-text-muted text-xs font-mono mt-6">{contactInfo.email}</p>
        </div>

        <p className="text-center text-text-muted text-xs mt-14">
